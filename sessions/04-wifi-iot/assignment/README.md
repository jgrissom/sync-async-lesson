...
All the scaffolding is in [`game_online_STARTER.py`](../code/game_online_STARTER.py) — grafts 1–4 and TODOs 1–3, exactly as Part C walked through. Your game is either your own Session 3 file or [`reaction_game_BASE.py`](../code/reaction_game_BASE.py) — both are fine; grading is identical. Board also needs `secrets.py`, `wifi_connect.py`, and `async_http.py`.
